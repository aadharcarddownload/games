...
(function() {
    ...
    function Runner(outerContainerId, opt_config) {
        ...
        // Add the event listener to prevent scrolling with spacebar and arrow keys
    ...
    Runner.prototype = {
        ...
        gameOver: function() {
            ...
            if (this.distanceRan > this.highestScore) {
                ...
                var score_d = 0;
                var scoreElement = document.getElementById("score-5");
                if (scoreElement !== null) {
                    score_d = scoreElement.innerHTML;
                }

                if (currentScore > score_d) {
                    var xhr = new XMLHttpRequest();
                    xhr.open('GET', '/game/checkscore.aspx?score=' + currentScore, false);
                    xhr.send();
                    ...
                    if (xhr.status === 200 && xhr.responseText !== '') {
                        if (user_name === '') {
                            ...
                            user_name = prompt(xhr.responseText, user_name);
                        }

                        setCookie('user_name', user_name, 365); // Store user_name in a cookie for 1 year

                        xhr.open('GET', '/game/setscore.aspx?name=' + encodeURIComponent(user_name) + '&score=' + currentScore, false);
                        xhr.send();
